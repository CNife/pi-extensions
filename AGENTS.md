...
│       ├── SKILL.md                       # 入口文档：流水线全景、变更目录解析、Plannotator入口
...
- 本项目中：`skills/development-workflow/SKILL.md` 提供 9 阶段工作流全景、
...
- **变更流程**：`write-plan → review-plan → plan-to-tasks → write-code ⇄ review-code ⇄ fix-code → write-test ⇄ review-test → write-docs`
